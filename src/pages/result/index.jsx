...
function Result() {
    ...
    useEffect(() => {
        ...
        if (lastRequest && lastRequest.image_name) {
            img.src = `http://192.168.122.110:9000/history/${results.image_name}`
        } else {
                                                ...
                                                <img 
                                                    src={
                                                        boxes[currentSubjectIndex].results[0].metadata.photo 
                                                            ? `http://192.168.122.110:9000/photos/${boxes[currentSubjectIndex].results[0].metadata.photo}` 
                                                            : mockPhoto
                                                    } 
                                                    alt="Udostak" 
                                                />
        ...
        <div className="card">
            <div className="photo">
                <img 
                    src={
                        image 
                            ? `http://192.168.122.110:9000/photos/${image}` 
                            : mockPhoto
                    } 
                />
